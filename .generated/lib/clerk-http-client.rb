...
# Models
ClerkHttpClient.autoload :AWSCredential, 'clerk-http-client/models/aws_credential'
...
ClerkHttpClient.autoload :DeleteMachine200Response, 'clerk-http-client/models/delete_machine200_response'
ClerkHttpClient.autoload :DeleteMachineScope200Response, 'clerk-http-client/models/delete_machine_scope200_response'
...
ClerkHttpClient.autoload :ExtendFreeTrialRequest, 'clerk-http-client/models/extend_free_trial_request'
...
ClerkHttpClient.autoload :ListMachines200Response, 'clerk-http-client/models/list_machines200_response'
...
ClerkHttpClient.autoload :OAuthAccessTokenInner, 'clerk-http-client/models/oauth_access_token_inner'
...
ClerkHttpClient.autoload :PaginatedCommerceSubscriptionItemResponse, 'clerk-http-client/models/paginated_commerce_subscription_item_response'
...
ClerkHttpClient.autoload :RotateMachineSecretKeyRequest, 'clerk-http-client/models/rotate_machine_secret_key_request'
...
ClerkHttpClient.autoload :SessionRefresh, 'clerk-http-client/models/session_refresh'
...
ClerkHttpClient.autoload :UpdateAWSCredentialRequest, 'clerk-http-client/models/update_aws_credential_request'
...
ClerkHttpClient.autoload :UpdateMachineRequest, 'clerk-http-client/models/update_machine_request'
...
ClerkHttpClient.autoload :VerificationEmailLink, 'clerk-http-client/models/verification_email_link'
...
# APIs
ClerkHttpClient.autoload :AWSCredentialsApi, 'clerk-http-client/api/aws_credentials_api'
ClerkHttpClient.autoload :AccountlessApplicationsApi, 'clerk-http-client/api/accountless_applications_api'
...
module ClerkHttpClient
  ...
  class SDK
    ...
    def aws_credentials
      ClerkHttpClient::AWSCredentialsApi.new
    end

    def accountless_applications
      ClerkHttpClient::AccountlessApplicationsApi.new
    end
    ...
    def machines
      ClerkHttpClient::MachinesApi.new
    end
    ...
    def oauth_access_tokens
      ClerkHttpClient::OAuthAccessTokensApi.new
    end
