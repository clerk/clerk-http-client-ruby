...
module ClerkHttpClient
  class ActorTokensApi
    ...
    def create_actor_token(opts = {})
      data, _status_code, _headers = create_actor_token_with_http_info(opts)
      data
    end
    ...
    # POST 
    def create_actor_token_with_http_info(opts = {})
    ...
    def revoke_actor_token(actor_token_id, opts = {})
      data, _status_code, _headers = revoke_actor_token_with_http_info(actor_token_id, opts)
      data
    end
    ...
    # @return [Array<(ActorToken, Integer, Hash)>] ActorToken data, response status code and response headers
    # POST 
    def revoke_actor_token_with_http_info(actor_token_id, opts = {})
      if @api_client.config.debugging
