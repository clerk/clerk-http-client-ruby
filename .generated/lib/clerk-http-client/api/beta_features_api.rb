...
module ClerkHttpClient
  class BetaFeaturesApi
    ...
    def change_production_instance_domain(opts = {})
      change_production_instance_domain_with_http_info(opts)
      nil
    end
    ...
    # POST 
    def change_production_instance_domain_with_http_info(opts = {})
    ...
    def update_instance_auth_config(opts = {})
      data, _status_code, _headers = update_instance_auth_config_with_http_info(opts)
      data
    end
    ...
    # PATCH 
    def update_instance_auth_config_with_http_info(opts = {})
      if @api_client.config.debugging
