...
module ClerkHttpClient
  class EmailAddressesApi
    ...
    def create_email_address(opts = {})
      data, _status_code, _headers = create_email_address_with_http_info(opts)
      data
    end
    ...
    # POST 
    def create_email_address_with_http_info(opts = {})
    ...
    def delete_email_address(email_address_id, opts = {})
      data, _status_code, _headers = delete_email_address_with_http_info(email_address_id, opts)
      data
    end
    ...
    # DELETE 
    def delete_email_address_with_http_info(email_address_id, opts = {})
      if @api_client.config.debugging
    ...
    def get_email_address(email_address_id, opts = {})
      data, _status_code, _headers = get_email_address_with_http_info(email_address_id, opts)
      data
    end
    ...
    # @return [Array<(EmailAddress, Integer, Hash)>] EmailAddress data, response status code and response headers
    # GET 
    def get_email_address_with_http_info(email_address_id, opts = {})
      if @api_client.config.debugging
    ...
    def update_email_address(email_address_id, opts = {})
      data, _status_code, _headers = update_email_address_with_http_info(email_address_id, opts)
      data
    end
    ...
    # @return [Array<(EmailAddress, Integer, Hash)>] EmailAddress data, response status code and response headers
    # PATCH 
    def update_email_address_with_http_info(email_address_id, opts = {})
      if @api_client.config.debugging
