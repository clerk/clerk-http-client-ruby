...
module ClerkHttpClient
  class EmailSMSTemplatesApi
    ...
    def get_template(template_type, slug, opts = {})
      data, _status_code, _headers = get_template_with_http_info(template_type, slug, opts)
      data
    end
    ...
    # GET 
    def get_template_with_http_info(template_type, slug, opts = {})
    ...
    def get_template_list(template_type, opts = {})
      data, _status_code, _headers = get_template_list_with_http_info(template_type, opts)
      data
    end
    ...
    # GET array
    def get_template_list_with_http_info(template_type, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 500
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling EmailSMSTemplatesApi.get_template_list, must be smaller than or equal to 500.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling EmailSMSTemplatesApi.get_template_list, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling EmailSMSTemplatesApi.get_template_list, must be greater than or equal to 0.'
      end
    ...
    def preview_template(template_type, slug, opts = {})
      data, _status_code, _headers = preview_template_with_http_info(template_type, slug, opts)
      data
    end
    ...
    # POST 
    def preview_template_with_http_info(template_type, slug, opts = {})
      if @api_client.config.debugging
    ...
    def revert_template(template_type, slug, opts = {})
      data, _status_code, _headers = revert_template_with_http_info(template_type, slug, opts)
      data
    end
    ...
    # @return [Array<(Template, Integer, Hash)>] Template data, response status code and response headers
    # POST 
    def revert_template_with_http_info(template_type, slug, opts = {})
      if @api_client.config.debugging
    ...
    def toggle_template_delivery(template_type, slug, opts = {})
      data, _status_code, _headers = toggle_template_delivery_with_http_info(template_type, slug, opts)
      data
    end
    ...
    # @return [Array<(Template, Integer, Hash)>] Template data, response status code and response headers
    # POST 
    def toggle_template_delivery_with_http_info(template_type, slug, opts = {})
      if @api_client.config.debugging
    ...
    def upsert_template(template_type, slug, opts = {})
      data, _status_code, _headers = upsert_template_with_http_info(template_type, slug, opts)
      data
    end
    ...
    # @return [Array<(Template, Integer, Hash)>] Template data, response status code and response headers
    # PUT 
    def upsert_template_with_http_info(template_type, slug, opts = {})
      if @api_client.config.debugging
