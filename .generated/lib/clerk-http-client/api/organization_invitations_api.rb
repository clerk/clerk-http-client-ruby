...
module ClerkHttpClient
  class OrganizationInvitationsApi
    ...
    def create_organization_invitation_bulk(organization_id, create_organization_invitation_request, opts = {})
      data, _status_code, _headers = create_organization_invitation_bulk_with_http_info(organization_id, create_organization_invitation_request, opts)
      data
    end
    ...
    # POST 
    def create_organization_invitation_bulk_with_http_info(organization_id, create_organization_invitation_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && create_organization_invitation_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_organization_invitation_request' when calling OrganizationInvitationsApi.create_organization_invitation_bulk"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :status Filter organization invitations based on their status
    # @option opts [String] :email_address Returns organization invitations inviting the specified email address.
    # @option opts [String] :order_by Allows to return organization invitations in a particular order. You can order the returned organization invitations either by their &#x60;created_at&#x60; or &#x60;email_address&#x60;. In order to specify the direction, you can use the &#x60;+/-&#x60; symbols prepended in the property to order by. For example, if you want organization invitations to be returned in descending order according to their &#x60;created_at&#x60; property, you can use &#x60;-created_at&#x60;. If you don&#39;t use &#x60;+&#x60; or &#x60;-&#x60;, then &#x60;+&#x60; is implied. Defaults to &#x60;-created_at&#x60;. (default to '-created_at')
    # @option opts [Integer] :limit Applies a limit to the number of results returned. Can be used for paginating the results together with &#x60;offset&#x60;. (default to 10)
    # @option opts [Integer] :offset Skip the first &#x60;offset&#x60; results when paginating. Needs to be an integer greater or equal to zero. To be used in conjunction with &#x60;limit&#x60;. (default to 0)
    # @return [OrganizationInvitations]
