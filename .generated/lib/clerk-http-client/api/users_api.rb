...
module ClerkHttpClient
  class UsersApi
    ...
    # @param users_ban_request [UsersBanRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<User>]

    def users_ban(users_ban_request, opts = {})
      data, _status_code, _headers = users_ban_with_http_info(users_ban_request, opts)
      data
    end
    ...
    # @return [Array<(Array<User>, Integer, Hash)>] Array<User> data, response status code and response headers
    # POST array
    def users_ban_with_http_info(users_ban_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.users_ban ...'
      end
      # verify the required parameter 'users_ban_request' is set
      if @api_client.config.client_side_validation && users_ban_request.nil?
        fail ArgumentError, "Missing the required parameter 'users_ban_request' when calling UsersApi.users_ban"
      end
      # resource path
      local_var_path = '/users/ban'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(users_ban_request)
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#users_ban\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param users_unban_request [UsersUnbanRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<User>]

    def users_unban(users_unban_request, opts = {})
      data, _status_code, _headers = users_unban_with_http_info(users_unban_request, opts)
      data
    end
    ...
    # @return [Array<(Array<User>, Integer, Hash)>] Array<User> data, response status code and response headers
    # POST array
    def users_unban_with_http_info(users_unban_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.users_unban ...'
      end
      # verify the required parameter 'users_unban_request' is set
      if @api_client.config.client_side_validation && users_unban_request.nil?
        fail ArgumentError, "Missing the required parameter 'users_unban_request' when calling UsersApi.users_unban"
      end
      # resource path
      local_var_path = '/users/unban'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(users_unban_request)
      ...
      new_options = opts.merge(
        :operation => :"UsersApi.users_unban",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#users_unban\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
