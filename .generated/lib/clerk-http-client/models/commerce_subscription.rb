...
module ClerkHttpClient
  class CommerceSubscription
    ...
    attr_accessor :eligible_for_free_trial
    ...
    def self.openapi_types
      {
        ...
        :'active_at' => :'Integer',
        :'past_due_at' => :'Integer',
        :'subscription_items' => :'Array<CommerceSubscriptionItem>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::CommerceSubscription` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::CommerceSubscription`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'eligible_for_free_trial')
        self.eligible_for_free_trial = attributes[:'eligible_for_free_trial']
      end
    end
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["commerce_subscription"])
      return false unless object_validator.valid?(@object)
      return false if @id.nil?
      return false if @instance_id.nil?
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["active", "past_due", "canceled", "ended", "abandoned", "incomplete"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["commerce_subscription"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["active", "past_due", "canceled", "ended", "abandoned", "incomplete"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          eligible_for_free_trial == o.eligible_for_free_trial
    end
    ...
    def hash
      [object, id, instance_id, status, payer_id, created_at, updated_at, active_at, past_due_at, subscription_items, next_payment, eligible_for_free_trial].hash
    end
