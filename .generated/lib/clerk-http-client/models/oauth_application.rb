...
module ClerkHttpClient
  class OAuthApplication
    ...
    def hash
      [object, id, instance_id, name, client_id, client_uri, client_image_url, dynamically_registered, consent_screen_enabled, pkce_required, public, scopes, redirect_uris, callback_url, authorize_url, token_fetch_url, user_info_url, discovery_url, token_introspection_url, created_at, updated_at].hash
    end
