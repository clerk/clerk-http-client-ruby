  ...
  class OrganizationInvitationWithPublicOrganizationData
    ...
    def self.openapi_types
      {
        ...
        :'url' => :'String',
        :'public_organization_data' => :'OrganizationInvitationWithPublicOrganizationDataPublicOrganizationData',
        :'created_at' => :'Integer',
        :'updated_at' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::OrganizationInvitationWithPublicOrganizationData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::OrganizationInvitationWithPublicOrganizationData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["organization_invitation"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["organization_invitation"])
    ...
    def hash
      [id, object, email_address, role, role_name, organization_id, status, public_metadata, private_metadata, url, public_organization_data, created_at, updated_at].hash
    end
