...
module ClerkHttpClient
  class OrganizationWithLogo
    ...
    def hash
      [object, id, name, slug, members_count, missing_member_with_elevated_permissions, pending_invitations_count, max_allowed_memberships, admin_delete_enabled, public_metadata, private_metadata, created_by, created_at, updated_at, logo_url, image_url, has_image].hash
    end
