...
module ClerkHttpClient
  class Session
    ...
    attr_accessor :last_active_organization_id
    ...
    def self.openapi_types
      {
        ...
        :'latest_activity' => :'SessionActivityResponse',
        :'expire_at' => :'Integer',
        :'abandon_at' => :'Integer',
        :'updated_at' => :'Integer',
        :'created_at' => :'Integer'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::Session` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::Session`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_active_organization_id')
        self.last_active_organization_id = attributes[:'last_active_organization_id']
      end
      ...
      if attributes.key?(:'latest_activity')
        self.latest_activity = attributes[:'latest_activity']
      end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["active", "revoked", "ended", "expired", "removed", "abandoned", "replaced"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["active", "revoked", "ended", "expired", "removed", "abandoned", "replaced"])
    ...
    def hash
      [object, id, user_id, client_id, actor, status, last_active_organization_id, last_active_at, latest_activity, expire_at, abandon_at, updated_at, created_at].hash
    end
