  ...
  class UpdateInstanceOrganizationSettingsRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::UpdateInstanceOrganizationSettingsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::UpdateInstanceOrganizationSettingsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'creator_role_id')
        self.creator_role_id = attributes[:'creator_role_id']
      end

      if attributes.key?(:'domains_default_role_id')
        self.domains_default_role_id = attributes[:'domains_default_role_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          creator_role_id == o.creator_role_id &&
          domains_default_role_id == o.domains_default_role_id
    end
    ...
    def hash
      [enabled, max_allowed_memberships, admin_delete_enabled, domains_enabled, domains_enrollment_modes, creator_role_id, domains_default_role_id].hash
    end
