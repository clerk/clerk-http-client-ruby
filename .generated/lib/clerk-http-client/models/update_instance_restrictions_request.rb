...
module ClerkHttpClient
  class UpdateInstanceRestrictionsRequest
    ...
    attr_accessor :ignore_dots_for_gmail_addresses
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::UpdateInstanceRestrictionsRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::UpdateInstanceRestrictionsRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ignore_dots_for_gmail_addresses')
        self.ignore_dots_for_gmail_addresses = attributes[:'ignore_dots_for_gmail_addresses']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ignore_dots_for_gmail_addresses == o.ignore_dots_for_gmail_addresses
    end
    ...
    def hash
      [allowlist, blocklist, block_email_subaddresses, block_disposable_email_domains, ignore_dots_for_gmail_addresses].hash
    end
