  ...
  class VerificationAdmin
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::VerificationAdmin` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::VerificationAdmin`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["verification_admin"])
      return false unless object_validator.valid?(@object)
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["verified"])
      return false unless status_validator.valid?(@status)
      return false if @strategy.nil?
      strategy_validator = EnumAttributeValidator.new('String', ["admin"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["verification_admin"])
    ...
    def strategy=(strategy)
      validator = EnumAttributeValidator.new('String', ["admin"])
