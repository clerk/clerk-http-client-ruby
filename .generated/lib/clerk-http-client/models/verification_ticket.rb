  ...
  class VerificationTicket
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkHttpClient::VerificationTicket` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkHttpClient::VerificationTicket`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      object_validator = EnumAttributeValidator.new('String', ["verification_ticket"])
      return false unless object_validator.valid?(@object)
      return false if @status.nil?
      status_validator = EnumAttributeValidator.new('String', ["unverified", "verified", "expired"])
      return false unless status_validator.valid?(@status)
      return false if @strategy.nil?
      strategy_validator = EnumAttributeValidator.new('String', ["ticket"])
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["verification_ticket"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["unverified", "verified", "expired"])
    ...
    def hash
      [object, status, strategy, attempts, expire_at, verified_at_client].hash
    end
