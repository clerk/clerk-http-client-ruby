...
# Unit tests for ClerkHttpClient::JWKSEcdsaPublicKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::JWKSEcdsaPublicKey do
  let(:instance) { ClerkHttpClient::JWKSEcdsaPublicKey.new }

  describe 'test an instance of JWKSEcdsaPublicKey' do
    it 'should create an instance of JWKSEcdsaPublicKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::JWKSEcdsaPublicKey)
    end
  end
