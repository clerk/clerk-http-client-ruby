...
# Unit tests for ClerkHttpClient::JWKSRsaPrivateKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::JWKSRsaPrivateKey do
  let(:instance) { ClerkHttpClient::JWKSRsaPrivateKey.new }

  describe 'test an instance of JWKSRsaPrivateKey' do
    it 'should create an instance of JWKSRsaPrivateKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::JWKSRsaPrivateKey)
    end
  end
