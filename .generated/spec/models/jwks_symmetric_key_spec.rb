...
# Unit tests for ClerkHttpClient::JWKSSymmetricKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::JWKSSymmetricKey do
  let(:instance) { ClerkHttpClient::JWKSSymmetricKey.new }

  describe 'test an instance of JWKSSymmetricKey' do
    it 'should create an instance of JWKSSymmetricKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::JWKSSymmetricKey)
    end
  end
  ...
  describe 'test attribute "kty"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["oct"])
