...
# Unit tests for ClerkHttpClient::JWKSEd25519PrivateKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::JWKSEd25519PrivateKey do
  let(:instance) { ClerkHttpClient::JWKSEd25519PrivateKey.new }

  describe 'test an instance of JWKSEd25519PrivateKey' do
    it 'should create an instance of JWKSEd25519PrivateKey' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::JWKSEd25519PrivateKey)
    end
  end
