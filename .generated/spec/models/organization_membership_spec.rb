...
# Unit tests for ClerkHttpClient::OrganizationMembership
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::OrganizationMembership do
  let(:instance) { ClerkHttpClient::OrganizationMembership.new }

  describe 'test an instance of OrganizationMembership' do
    it 'should create an instance of OrganizationMembership' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::OrganizationMembership)
    end
  end
