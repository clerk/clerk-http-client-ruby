...
# Unit tests for ClerkHttpClient::OTP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::OTP do
  let(:instance) { ClerkHttpClient::OTP.new }

  describe 'test an instance of OTP' do
    it 'should create an instance of OTP' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::OTP)
    end
  end
