...
# Unit tests for ClerkHttpClient::VerificationOtp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::VerificationOtp do
  let(:instance) { ClerkHttpClient::VerificationOtp.new }

  describe 'test an instance of VerificationOtp' do
    it 'should create an instance of VerificationOtp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::VerificationOtp)
    end
  end
  ...
  describe 'test attribute "object"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["verification_otp"])
