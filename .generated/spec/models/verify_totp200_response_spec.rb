...
# Unit tests for ClerkHttpClient::VerifyTOTP200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::VerifyTOTP200Response do
  let(:instance) { ClerkHttpClient::VerifyTOTP200Response.new }

  describe 'test an instance of VerifyTOTP200Response' do
    it 'should create an instance of VerifyTOTP200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::VerifyTOTP200Response)
    end
  end
