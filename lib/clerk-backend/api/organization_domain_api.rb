...
module ClerkBackend
  class OrganizationDomainApi
    ...
    def update_domain(organization_id, domain_id, update_organization_domain_request, opts = {})
      data, _status_code, _headers = update_domain_with_http_info(organization_id, domain_id, update_organization_domain_request, opts)
      data
    end
    ...
    # PATCH 
    def update_domain_with_http_info(organization_id, domain_id, update_organization_domain_request, opts = {})
