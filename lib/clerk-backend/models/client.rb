...
module ClerkBackend
  class Client
    ...
    attr_accessor :sign_in_id

    attr_accessor :sign_up_id

    # Last active session_id. 
    attr_accessor :last_active_session_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ClerkBackend::Client` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ClerkBackend::Client`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sign_in_id')
        self.sign_in_id = attributes[:'sign_in_id']
      else
        self.sign_in_id = nil
      end

      if attributes.key?(:'sign_up_id')
        self.sign_up_id = attributes[:'sign_up_id']
      else
        self.sign_up_id = nil
      end
    ...
    def object=(object)
      validator = EnumAttributeValidator.new('String', ["client"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sessions == o.sessions &&
          sign_in_id == o.sign_in_id &&
          sign_up_id == o.sign_up_id &&
    ...
    def hash
      [object, id, session_ids, sessions, sign_in_id, sign_up_id, last_active_session_id, updated_at, created_at].hash
    end
