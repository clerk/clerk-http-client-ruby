...
module ClerkHttpClient
  class AllowListBlockListApi
    ...
    # @param create_allowlist_identifier_request [CreateAllowlistIdentifierRequest] 
    ...
    # @param create_blocklist_identifier_request [CreateBlocklistIdentifierRequest] 
    # @param [Hash] opts the optional parameters
    # @return [BlocklistIdentifier]

    def create(create_blocklist_identifier_request, opts = {})
      data, _status_code, _headers = create_with_http_info(create_blocklist_identifier_request, opts)
      data
    end
    ...
    # POST 
    def create_with_http_info(create_blocklist_identifier_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AllowListBlockListApi.create_blocklist_identifier ...'
      end
      # verify the required parameter 'create_blocklist_identifier_request' is set
      if @api_client.config.client_side_validation && create_blocklist_identifier_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_blocklist_identifier_request' when calling AllowListBlockListApi.create_blocklist_identifier"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_blocklist_identifier_request)
