...
module ClerkHttpClient
  class ClientsApi
    ...
    # @param verify_client_request [VerifyClientRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Client]

    def verify(verify_client_request, opts = {})
      data, _status_code, _headers = verify_with_http_info(verify_client_request, opts)
      data
    end
    ...
    # @return [Array<(Client, Integer, Hash)>] Client data, response status code and response headers
    # POST 
    def verify_with_http_info(verify_client_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ClientsApi.verify_client ...'
      end
      # verify the required parameter 'verify_client_request' is set
      if @api_client.config.client_side_validation && verify_client_request.nil?
        fail ArgumentError, "Missing the required parameter 'verify_client_request' when calling ClientsApi.verify_client"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(verify_client_request)
