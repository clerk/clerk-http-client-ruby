...
module ClerkHttpClient
  class InvitationsApi
    ...
    def create(create_invitation_request, opts = {})
      data, _status_code, _headers = create_with_http_info(create_invitation_request, opts)
      data
    end
    ...
    # POST 
    def create_with_http_info(create_invitation_request, opts = {})
