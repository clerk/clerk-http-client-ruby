...
module ClerkHttpClient
  class OAuthApplicationsApi
    ...
    # @param create_o_auth_application_request [CreateOAuthApplicationRequest] 
    # @param [Hash] opts the optional parameters
    # @return [OAuthApplicationWithSecret]

    def create(create_o_auth_application_request, opts = {})
      data, _status_code, _headers = create_with_http_info(create_o_auth_application_request, opts)
      data
    end
    ...
    # POST 
    def create_with_http_info(create_o_auth_application_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OAuthApplicationsApi.create_o_auth_application ...'
      end
      # verify the required parameter 'create_o_auth_application_request' is set
      if @api_client.config.client_side_validation && create_o_auth_application_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_o_auth_application_request' when calling OAuthApplicationsApi.create_o_auth_application"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_o_auth_application_request)
    ...
    def delete(oauth_application_id, opts = {})
      data, _status_code, _headers = delete_with_http_info(oauth_application_id, opts)
      data
    end
    ...
    # DELETE 
    def delete_with_http_info(oauth_application_id, opts = {})
      if @api_client.config.debugging
    ...
    def find(oauth_application_id, opts = {})
      data, _status_code, _headers = find_with_http_info(oauth_application_id, opts)
      data
    end
    ...
    # GET 
    def find_with_http_info(oauth_application_id, opts = {})
      if @api_client.config.debugging
    ...
    def rotate_secret(oauth_application_id, opts = {})
      data, _status_code, _headers = rotate_secret_with_http_info(oauth_application_id, opts)
      data
    end
    ...
    # @return [Array<(OAuthApplicationWithSecret, Integer, Hash)>] OAuthApplicationWithSecret data, response status code and response headers
    # POST 
    def rotate_secret_with_http_info(oauth_application_id, opts = {})
      if @api_client.config.debugging
    ...
    def update(oauth_application_id, update_o_auth_application_request, opts = {})
      data, _status_code, _headers = update_with_http_info(oauth_application_id, update_o_auth_application_request, opts)
      data
    end
    ...
    # @return [Array<(OAuthApplication, Integer, Hash)>] OAuthApplication data, response status code and response headers
    # PATCH 
    def update_with_http_info(oauth_application_id, update_o_auth_application_request, opts = {})
      if @api_client.config.debugging
