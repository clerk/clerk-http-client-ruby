...
module ClerkHttpClient
  class PhoneNumbersApi
    ...
    # @param create_phone_number_request [CreatePhoneNumberRequest] 
    # @param [Hash] opts the optional parameters
    # @return [PhoneNumber]

    def create(create_phone_number_request, opts = {})
      data, _status_code, _headers = create_with_http_info(create_phone_number_request, opts)
      data
    end
    ...
    # POST 
    def create_with_http_info(create_phone_number_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PhoneNumbersApi.create_phone_number ...'
      end
      # verify the required parameter 'create_phone_number_request' is set
      if @api_client.config.client_side_validation && create_phone_number_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_phone_number_request' when calling PhoneNumbersApi.create_phone_number"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_phone_number_request)
    ...
    # @param update_phone_number_request [UpdatePhoneNumberRequest] 
    # @param [Hash] opts the optional parameters
    # @return [PhoneNumber]

    def update(phone_number_id, update_phone_number_request, opts = {})
      data, _status_code, _headers = update_with_http_info(phone_number_id, update_phone_number_request, opts)
      data
    end
    ...
    # @return [Array<(PhoneNumber, Integer, Hash)>] PhoneNumber data, response status code and response headers
    # PATCH 
    def update_with_http_info(phone_number_id, update_phone_number_request, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'update_phone_number_request' is set
      if @api_client.config.client_side_validation && update_phone_number_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_phone_number_request' when calling PhoneNumbersApi.update_phone_number"
      end
      # resource path
      local_var_path = '/phone_numbers/{phone_number_id}'.sub('{' + 'phone_number_id' + '}', CGI.escape(phone_number_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_phone_number_request)
