...
module ClerkHttpClient
  class RedirectURLsApi
    ...
    # Create a redirect URL
    # @param create_redirect_url_request [CreateRedirectURLRequest] 
    # @param [Hash] opts the optional parameters
    # @return [RedirectURL]

    def create(create_redirect_url_request, opts = {})
      data, _status_code, _headers = create_with_http_info(create_redirect_url_request, opts)
      data
    end
    ...
    # POST 
    def create_with_http_info(create_redirect_url_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RedirectURLsApi.create_redirect_url ...'
      end
      # verify the required parameter 'create_redirect_url_request' is set
      if @api_client.config.client_side_validation && create_redirect_url_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_redirect_url_request' when calling RedirectURLsApi.create_redirect_url"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_redirect_url_request)
