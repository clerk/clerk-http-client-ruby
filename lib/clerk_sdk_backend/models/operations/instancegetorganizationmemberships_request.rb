...
module ClerkSDKBackend
  module Operations
    ...
    class InstanceGetOrganizationMembershipsRequest < ::ClerkSDKBackend::Utils::FieldAugmented
      extend T::Sig
      ...
      sig { params(limit: T.nilable(::Float), offset: T.nilable(::Float), order_by: T.nilable(::String)).void }
      def initialize(limit: nil, offset: nil, order_by: nil)
        @limit = limit
        @offset = offset
        @order_by = order_by
      end
