...
module ClerkSDKBackend
  module Shared
    ...
    class OrganizationMembershipOrganization < ::ClerkSDKBackend::Utils::FieldAugmented
      extend T::Sig
      ...
      field :object, ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationObject, { 'format_json': { 'letter_case': ::ClerkSDKBackend::Utils.field_name('object'), 'decoder': Utils.enum_from_string(::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationObject, false) } }

      field :private_metadata, ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationPrivateMetadata, { 'format_json': { 'letter_case': ::ClerkSDKBackend::Utils.field_name('private_metadata') } }

      field :public_metadata, ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationPublicMetadata, { 'format_json': { 'letter_case': ::ClerkSDKBackend::Utils.field_name('public_metadata') } }
      ...
      sig { params(created_at: ::Integer, id: ::String, max_allowed_memberships: ::Integer, name: ::String, object: ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationObject, private_metadata: ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationPrivateMetadata, public_metadata: ::ClerkSDKBackend::Shared::OrganizationMembershipOrganizationPublicMetadata, slug: ::String, updated_at: ::Integer, admin_delete_enabled: T.nilable(T::Boolean), created_by: T.nilable(::String), members_count: T.nilable(::Integer)).void }
