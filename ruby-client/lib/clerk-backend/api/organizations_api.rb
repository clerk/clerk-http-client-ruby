...
module ClerkBackend
  class OrganizationsApi
    ...
    def update_logo(organization_id, file, opts = {})
      data, _status_code, _headers = update_logo_with_http_info(organization_id, file, opts)
      data
    end
    ...
    # PUT 
    def update_logo_with_http_info(organization_id, file, opts = {})
      if @api_client.config.debugging
