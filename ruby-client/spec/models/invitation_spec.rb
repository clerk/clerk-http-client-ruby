...
# Unit tests for ClerkBackend::Invitation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkBackend::Invitation do
  let(:instance) { ClerkBackend::Invitation.new }

  describe 'test an instance of Invitation' do
    it 'should create an instance of Invitation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkBackend::Invitation)
    end
  end
