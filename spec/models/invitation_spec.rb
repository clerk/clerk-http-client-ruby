...
# Unit tests for ClerkHttpClient::Invitation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ClerkHttpClient::Invitation do
  let(:instance) { ClerkHttpClient::Invitation.new }

  describe 'test an instance of Invitation' do
    it 'should create an instance of Invitation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ClerkHttpClient::Invitation)
    end
  end
